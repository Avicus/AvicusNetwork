...
/**
 * <b>ReflectionUtils</b> <p> This class provides useful methods which makes dealing with reflection
 * much easier, especially when working with Bukkit <p> You are welcome to use it, modify it and
 * redistribute it under the following conditions: <ul> <li>Don't claim this class as your own
 * <li>Don't remove this disclaimer </ul> <p> <i>It would be nice if you provide credit to me if you
...
public final class ReflectionUtils {
  ...
  public static Constructor<?> getConstructor(Class<?> clazz, Class<?>... parameterTypes)
    ...
    for (Constructor<?> constructor : clazz.getConstructors()) {
      if (!DataType
          .compare(DataType.getPrimitive(constructor.getParameterTypes()), primitiveTypes)) {
        continue;
      }
      return constructor;
    }
   ...
   * of the constructor (this should not occur since it searches for a constructor with the types of
   * the arguments)
